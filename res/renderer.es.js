...
var GLSL_FUNC = /** @class */ (function () {
    ...
    GLSL_FUNC.prototype.mergeCode = function () {
        var source = GLSL[this.rettype] + " " + this.name + " (";
...
var GLShaderComposerBase = /** @class */ (function () {
    ...
    GLShaderComposerBase.prototype.attr = function (type, sym, prefix) {
        if (prefix === void 0) { prefix = GLSL.in; }
    ...
    GLShaderComposerBase.prototype.mergeShaderSource = function () {
        ...
        this.m_varys.forEach(function (v) {
            var prefix = v.prefix == null ? (_this.m_shadertype == GLSL.vs ? GLSL.out : GLSL.in) : v.prefix;
            var vtype = v.type;
            var vstr = vtype;
...
var GLContext = /** @class */ (function () {
    ...
    GLContext.prototype.drawTexCheckInit = function () {
        ...
        //vs
        var shadervs = GLShaderComposer.create(GLSL.vs)
            ...
            .compile();
        //ps
        var shaderps = GLShaderComposer.create(GLSL.ps)
            ...
            .compile();
        //ps color
        var shaderpsCol = GLShaderComposer.create(GLSL.ps)
            .precision(GLSL.float, GLSL.lowp)
...
export { GLContext, GLProgram, GLUtility, glmath, vec4, vec3, quat, mat4, mat3, GLFrameBuffer, GLSL, GLSL_STRUCT, GLSL_FUNC, GLShaderComposerBase, GLShaderComposer, GLPipelineState, GLTFaccessor, GLTFanimation, GLTFanimationSampler, GLTFasset, GLTFbuffer, GLTFbufferView, GLTFcamera, GLTFchannel, GLTFimage, GLTFindices, GLTFmaterial, GLTFmesh, GLTFnode, GLTFnormalTextureInfo, GLTFocclusionTextureInfo, GLTForthographic, GLTFpbrMetallicRoughness, GLTFperspective, GLTFprimitive, GLTFsampler, GLTFscene, GLTFskin, GLTFsparse, GLTFtarget, GLTFtexture, GLTFtextureInfo, GLTFvalues, GLTFfile, GLTFdata, GLTFbinary, GLTFtool, DebugEntry, DebugCmd, GraphicsRenderCreateInfo, GraphicsRender, AmbientType, ClearType, ProjectionType, Camera, CameraFreeFly, FrameTimer, GameObject, InputSnapShot, Input, LightType, Light, MaterialPorpertyBlock, Material, MeshTopology, MeshVertexAttrDesc, MeshVertexDesc, MeshIndicesDesc, Mesh, MeshBufferUtility, Transform, Component, Delayter, Utility, SampleGame };
